            ...
            <div class="form-group m-0 col-md-4">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" :true-value="1" :false-value="0"
                  v-model="show_in_home_booking" id="show_in_home_booking" :checked="show_in_home_booking">
                <label class="form-check-label" for="show_in_home_booking">
                  {{ $t('employee.show_in_home_booking') }}
                </label>
              </div>
            </div>
...
const setFormData = (data) => {
  ...
  resetForm({
    values: {
      ...
      show_in_home_booking: data.show_in_home_booking, // جديد
...
const { value: show_in_home_booking } = useField('show_in_home_booking')
