...
class EmployeesController extends Controller
{
        ...
        foreach ($workingHours as $dayName => $data) {
            ...
            StaffWorkingHour::updateOrCreate(
                ...
                [
                    ...
                    'breaks' => isset($data['breaks']) ? json_encode($data['breaks']) : json_encode([]),
                ]
            );
        }
    ...
    public function store(EmployeeRequest $request)
    {
        ...
        $data['show_in_home_booking'] = $request->has('show_in_home_booking') ? 1 : 0;
    ...
    public function update(EmployeeRequest $request, $id)
    {
        ...
        $request_data['show_in_home_booking'] = $request->has('show_in_home_booking') ? 1 : 0;
