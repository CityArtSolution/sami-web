...
class PromotionsController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($coupon && $coupon->used_by == null) {
            $couponData = array_merge($couponData, [
    ...
    public function couponsview(Request $request)
    {
        ...
        $customefield = $promotion->users ;

        $export_url = route('backend.coupons.export', $promotion_id);

        return view('promotion::backend.promotions.coupon_datatable', compact('module_action', 'export_import', 'export_columns', 'export_url', 'promotion_id', 'promotion','services','customefield'));
    }
