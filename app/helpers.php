    ...
    function setting($key, $default = null)
    {
        ...
        if (is_array($key)) {
            foreach ($key as $settingKey => $settingValue) {
                return App\Models\Setting::set($settingKey, $settingValue);
            }
        }
...
/**
 * Send SMS using TAQNYAT gateway
 *
 ...
 * @return mixed
 */
function sendSms($recipients, $message, $sender = null)
{
    ...
    try {
        $taqnyatService = app('taqnyat-sms');
        return $taqnyatService->sendSms($recipients, $message, $sender);
    } catch (\Exception $e) {
...
function sendWelcomeSms($phone, $name)
{
    ...
    try {
        $taqnyatService = app('taqnyat-sms');
        return $taqnyatService->sendWelcomeMessage($phone, $name);
    } catch (\Exception $e) {
        Log::error('Welcome SMS sending failed: ' . $e->getMessage());
        return false;
    }
}

/**
 * Send booking created SMS message
 *
 * @param string $phone
 * @param array $bookingData
 * @return mixed
 */
function sendBookingCreatedSms($phone, $bookingData)
{
    if (!setting('is_taqnyat_sms')) {
        return false;
    }
    ...
    try {
        $taqnyatService = app('taqnyat-sms');
        return $taqnyatService->sendBookingCreatedMessage($phone, $bookingData);
    } catch (\Exception $e) {
        Log::error('Booking created SMS sending failed: ' . $e->getMessage());
        return false;
    }
}

/**
 * Send booking cancelled SMS message
 *
 * @param string $phone
 * @param array $bookingData
 * @return mixed
 */
function sendBookingCancelledSms($phone, $bookingData)
{
    if (!setting('is_taqnyat_sms')) {
        return false;
    }
    ...
    try {
        $taqnyatService = app('taqnyat-sms');
        return $taqnyatService->sendBookingCancelledMessage($phone, $bookingData);
    } catch (\Exception $e) {
        Log::error('Booking cancelled SMS sending failed: ' . $e->getMessage());
        return false;
    }
}

/**
 * Send booking reminder SMS message
 *
 * @param string $phone
 * @param array $bookingData
 * @return mixed
...
function sendBookingReminderSms($phone, $bookingData)
{
    ...
    try {
        $taqnyatService = app('taqnyat-sms');
        return $taqnyatService->sendBookingReminderMessage($phone, $bookingData);
    } catch (\Exception $e) {
        Log::error('Booking reminder SMS sending failed: ' . $e->getMessage());
        return false;
    }
}
 ...
 * @return mixed
 */
function sendPasswordResetSms($phone, $resetCode)
{
    if (!setting('is_taqnyat_sms')) {
        return false;
    }
    ...
    try {
        $taqnyatService = app('taqnyat-sms');
        return $taqnyatService->sendPasswordResetMessage($phone, $resetCode);
    } catch (\Exception $e) {
        Log::error('Password reset SMS sending failed: ' . $e->getMessage());
        return false;
    }
}
