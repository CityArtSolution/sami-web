    ...
    'integration' => [
        ...
        'elements' => [
            ...
            [
                'type' => 'checkbox', // input fields type
                'data' => 'integaration', // data type, string, int, boolean
                'name' => 'is_taqnyat_sms', // unique name for field
                'label' => 'integration', // you know what label it is
                'rules' => '', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '0', // default value if you want
                'help' => 'Enable TAQNYAT SMS Gateway', // Help text for the input field.
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'taqnyat_sms', // data type, string, int, boolean
                'name' => 'taqnyat_api_key', // unique name for field
                'label' => 'integration', // you know what label it is
                'rules' => 'required|max:191', // validation rule of laravel
                'class' => '', // any class for input
            ...
            [
                ...
                'data' => 'taqnyat_sms', // data type, string, int, boolean
                'name' => 'taqnyat_welcome_message', // unique name for field
                'label' => 'integration', // you know what label it is
                'rules' => 'required|max:500', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'مرحباً [[name]]! أهلاً وسهلاً بك في [[app_name]]. شكراً لك على التسجيل معنا.', // default value if you want
                'help' => 'رسالة الترحيب عند التسجيل الأول (استخدم [[name]] و [[app_name]] كمتغيرات)', // Help text for the input field.
            ],
            [
                'type' => 'textarea', // input fields type
                'data' => 'taqnyat_sms', // data type, string, int, boolean
                'name' => 'taqnyat_booking_created', // unique name for field
                'label' => 'integration', // you know what label it is
                'rules' => 'required|max:500', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'تم إنشاء حجزك بنجاح! رقم الحجز: [[booking_id]]. التاريخ: [[booking_date]] في [[booking_time]].', // default value if you want
            ...
            [
                ...
                'data'  => 'taqnyat_sms', // data type, string, int, boolean
                'name'  => 'taqnyat_recipient', // unique name for field
            ...
            [
                'type' => 'textarea', // input fields type
                'data' => 'taqnyat_sms', // data type, string, int, boolean
                'name' => 'taqnyat_booking_cancelled', // unique name for field
                'label' => 'integration', // you know what label it is
                'rules' => 'required|max:500', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'تم إلغاء حجزك رقم [[booking_id]] بنجاح. إذا كان لديك أي استفسار، لا تتردد في التواصل معنا.', // default value if you want
                'help' => 'رسالة عند إلغاء الحجز (استخدم [[booking_id]] كمتغير)', // Help text for the input field.
            ],
            [
                'type' => 'textarea', // input fields type
                'data' => 'taqnyat_sms', // data type, string, int, boolean
                'name' => 'taqnyat_booking_reminder', // unique name for field
                'label' => 'integration', // you know what label it is
                'rules' => 'required|max:500', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'تذكير: لديك موعد غداً في [[booking_time]] مع [[service_name]]. نرجو الحضور قبل الموعد بـ 10 دقائق.', // default value if you want
                'help' => 'رسالة تذكير قبل الموعد (استخدم [[booking_time]], [[service_name]] كمتغيرات)', // Help text for the input field.
            ],
            [
                'type' => 'textarea', // input fields type
                'data' => 'taqnyat_sms', // data type, string, int, boolean
                'name' => 'taqnyat_password_reset', // unique name for field
                'label' => 'integration', // you know what label it is
                'rules' => 'required|max:500', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'رمز إعادة تعيين كلمة المرور الخاص بك هو: [[reset_code]]. هذا الرمز صالح لمدة ساعة واحدة.', // default value if you want
                'help' => 'رسالة إعادة تعيين كلمة المرور (استخدم [[reset_code]] كمتغير)', // Help text for the input field.
            ],
        ],
